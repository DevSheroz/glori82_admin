...
export const ordersApi = {
  ...
  getShoppingList: () => api.get('/orders/shopping-list'),
  saveOverride: (data) => api.patch('/orders/shopping-list/override', data),
  resetOverrides: () => api.delete('/orders/shopping-list/overrides'),
